...
from sonolus.script.easing import ease_out_quad, ease_in_quad
    ...
    if LevelConfig.ui_version == Version.v3:
        ...
        if time >= 1.75 and time < 3:
            ...
            if time < 1.75:
                ...
                final_anim = ease_in_quad(mid_progress - exit_progress)
        ...
        final_anim = anim
        layout @= layout_skill_bar(text_current_center, w, h)
    if time <= 1.75 or LevelConfig.ui_version == Version.v1:
